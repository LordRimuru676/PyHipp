...
## /SBATCH -p general
#SBATCH -o rs3a-slurm.%N.%j.out
#SBATCH -e rs3a-slurm.%N.%j.err
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:419187349207:awsnotify --message "RPLS3AJobDone"
