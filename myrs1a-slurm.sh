...
## /SBATCH -p general
#SBATCH -o rs1a-slurm.%N.%j.out
#SBATCH -e rs1a-slurm.%N.%j.err
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:419187349207:awsnotify --message "RPLS1AJobDone"
